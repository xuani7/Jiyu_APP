            ...
            <view class="date">
                ...
                <swiper :style="{height:(retract ? 2 * 80 : (week_list.length + 1) * 80 ) + 'rpx'}" :current="current"
                    ...
                    <swiper-item>
                        ...
                        <view class="date_dl" v-show="!retract || index == to_week_index"
                ...
                <view class="foot">
                    <u-button class="button" type="primary" color="#7ecefd" text="打卡" icon="checkbox-mark" size="small"
                        shape="circle" @click="mark()"></u-button>
                    <u-button class="button" type="primary" color="#7ecefd" text="回到今天" icon="hourglass" size="small"
